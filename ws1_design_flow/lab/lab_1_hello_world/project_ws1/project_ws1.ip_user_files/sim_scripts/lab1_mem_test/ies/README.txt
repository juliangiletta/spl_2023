...
#
# Generated by export_simulation on Mon Mar 27 14:11:10 -0300 2023
#
################################################################################
...
'-reset_run' switch to the './lab1_mem_test.sh' script.

./lab1_mem_test.sh -reset_run
...
./lab1_mem_test.sh -noclean_files

For more information on the script, please type './lab1_mem_test.sh -help'.
