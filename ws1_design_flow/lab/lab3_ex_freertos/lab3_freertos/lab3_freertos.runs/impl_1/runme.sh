...
HD_PWD='C:/Users/jgiletta/Documents/Capacitaciones/spl_2023/ws1_design_flow/lab3_freertos/lab3_freertos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rtos_example_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rtos_example_wrapper.tcl -notrace
