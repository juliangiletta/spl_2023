...
HD_PWD='C:/Users/jgiletta/Documents/Capacitaciones/spl_2023/ws1_design_flow/lab3_freertos/lab3_freertos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rtos_example_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rtos_example_wrapper.tcl
