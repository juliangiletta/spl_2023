...
HD_PWD='C:/Users/jgiletta/Documents/Capacitaciones/spl_2023/ws1_design_flow/lab2_gpio/lab2_gpio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_gpio_in_out_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_gpio_in_out_wrapper.tcl -notrace
