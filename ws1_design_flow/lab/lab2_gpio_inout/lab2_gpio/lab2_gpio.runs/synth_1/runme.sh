...
HD_PWD='C:/Users/jgiletta/Documents/Capacitaciones/spl_2023/ws1_design_flow/lab2_gpio/lab2_gpio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_gpio_in_out_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_gpio_in_out_wrapper.tcl
